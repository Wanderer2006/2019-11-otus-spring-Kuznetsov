...
values ('Диалектика'), ('Питер'), ('Вильямс'), ('АСТ'), ('Азбука-Аттикус'), ('Эксмо');

insert into genres (genre)
values ('Повесть'), ('Роман'), ('Учебная литература'), ('Фантастика'), ('Компьютерная литература');
...
values ('Глуховский', 'Дмитрий', 'Алексеевич'), ('Гуляковский', 'Евгений', 'Яковлевич');

insert into visitors (last_name, first_name, second_name, age) 
values ('Иванов', 'Иван', 'Иванович', 30), ('Петров', 'Петр', 'Петрович', 18), ('Кузнецова', 'Дарья', 'Андреевна', 12), ('Сидоров', 'Сидор', 'Сидорович', 10);
...
values ('Философия Java', 2, 2, 2019, 3000, 12), ('Изучаем Java', 2, 6, 2018, 2000, 12), ('Java. Библиотека профессионала. Том 1. Основы', 2, 3, 2016, 2000, 12), 
       ...
       ('Планета для контакта', 2, 6, 2009, 2000, 12), ('Изучаем SQL', 2, 2, 2012, 2000, 12);
