...
public class BookServiceImpl implements BookService {
    ...
    public void showAllBooksFullInfo() {
        ...
        List<Relation> visitorRelation = visitorBookRelation.getAll();
    ...
    public void deleteBookById(Long id) {
        ...
        } else if (visitorBookRelation.countByRightId(id) > 0) {
    ...
    public void giveOutBook(Relation relation) {
        ...
        if (book.getCopies() == visitorBookRelation.countByRightId(relation.getRightId())) {
            ...
            if (visitor.getAge() < book.getAgeLimit()) {
                ...
                try {
                    visitorBookRelation.insert(new Relation(visitor.getVisitorId(), book.getBookId()));
    ...
    public void returnBook(Relation relation) {
        ...
        if (visitorBookRelation.countByRightId(bookId) == 0) {
            ...
            if (visitor == null) {
                ...
                try {
                    visitorBookRelation.delete(new Relation(visitor.getVisitorId(), bookId));
